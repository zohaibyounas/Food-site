    ...
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      <div className=" flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          Best <span className="font-black">Eats</span>
        </h1>
        <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]">
            <p className="bg-black text-white rounded-full p-2">Delivery</p>
            <p className="p-2">Packup</p>
        </div>
      </div>
      {/* serach input */}
      ...
      {/* cart button*/}
      <button className="bg-black text-white hidden md:flex items-center py-2 rounded-full p-5">
...
<div className={nav ? "fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300" :"fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300"}>
      ...
      <h2 className="text-2xl p-4">Best <span className="font-bold">Etas</span>
      </h2>
      <nav>
